...
@Component({
  selector: 'app-tarifavigencias',
  templateUrl: './tarifavigencias.component.html',
  styleUrls: ['./tarifavigencias.component.scss']
})
export class TarifavigenciasComponent implements OnInit {
