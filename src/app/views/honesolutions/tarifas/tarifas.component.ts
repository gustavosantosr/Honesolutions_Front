...
export class TarifasComponent implements OnInit {
  ...
  servicios: Servicio[];
  _alldata: any[];
  dataSource = new MatTableDataSource<Tarifa | Group>(this.getTarifas());
  tarifas: Tarifa[];
  ...
  getTarifa(): void {
    this.tarifaService.getTarifa(this.tarifaForm.get('IDTarifa').value)
      .subscribe(tarifa => this.tarifa = tarifa);
  }
