...
export class RolesComponent implements OnInit {
  ...
  _alldata: any[];
  dataSource = new MatTableDataSource<Rol | Group>(this.getRoles());
  roles: Rol[];
  ...
  getRol(): void {
    this.rolService.getRol(this.rolForm.get('IDRol').value)
  ...
  getRoles() {
    ...
    this.rolService.getRoles()
      .subscribe(roles => this.dataSource.data = roles);
  ...
  select(id: number): void {
    this.router.navigate(['proveedores/roles-detail/' + id]);
  }

  salida(row): void {
    this.router.navigate(['proveedores/salida-detail/' + row.IDRol]);
  }
  onRowClicked(row) {
    console.log('Row clicked: ', row);

    this.rolForm.setValue(row);
    this.btn_add = false;
    ...
    this.rolService.addRol(this.rol)
      .subscribe(data => {
        if (data) {
          ...
          this.getRoles();
          this.rolForm.reset();
          this.rolForm.controls['Activo'].setValue(true);
        } else {
